...
namespace GameProject
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            {
                if (teddy.Active && burger.CollisionRectangle.Intersects(teddy.CollisionRectangle))
                {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(font, scoreString, GameConstants.SCORE_LOCATION, Color.Green);
        ...
        private void SpawnBear()
        {
            ...
            float v = RandomNumberGenerator.NextFloat(GameConstants.BEAR_SPEED_RANGE);
            v += GameConstants.MIN_BEAR_SPEED;

            float angle = RandomNumberGenerator.NextFloat((float)Math.PI * 2);

            Vector2 velocity;
            velocity.X = v * (float)Math.Cos((double)angle);
            velocity.Y = v * (float)Math.Sin((double)angle);
